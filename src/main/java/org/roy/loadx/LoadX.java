...
/**
 * To use Eclipse TCP/IP Monitor (domain set up required to support SSO):
 * - configure /private/etc/hosts file with entry like: 127.0.0.1 localhost.qa01.cenx.localnet
 * - use host localhost.qa01.cenx.localnet:1234 as balancer URL in LoadX
